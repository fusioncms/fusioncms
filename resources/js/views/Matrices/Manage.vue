<template>
    <div>
        ...
        <portal to="actions">
            ...
            <p-button @click.prevent="submit" class="button button--primary" v-if="! isCollection">Save</p-button>
            <router-link :to="{ name: 'matrices' }" class="button" v-if="isCollection">Create Type</router-link>
        </portal>
