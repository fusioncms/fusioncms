        ...
        <div class="relative">
            ...
            >
                <div v-if="open" class="origin-top-right absolute right-0 mt-2 w-64 bg-white rounded-lg border shadow-md py-2">
                    <ul>
                        <li><a href="#" class="block px-4 py-2 hover:bg-indigo-500 hover:text-white">Profile</a></li>
                        <li><a href="#" class="block px-4 py-2 hover:bg-indigo-500 hover:text-white">Account Settings</a></li>
                        <li><a href="#" class="block px-4 py-2 hover:bg-indigo-500 hover:text-white">Sign Out</a></li>
                    </ul>
                </div>
            </transition>
        </div>
