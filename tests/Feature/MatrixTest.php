...
class MatrixTest extends TestCase
{
    ...
    {
        // Set the max execution time low, if this test fails we'll sit here until the
        // default 30 seconds execution limit has passed due to an infinite loop
        // being generated by assigning the parent ID value to itself.
