...
class Upgrade extends Command
{
    ...
    protected function startUpgrade()
    {
        $jobs = [
            ...
            'Preparing filesystem...'               => new \Fusion\Jobs\Upgrader\PrepareFilesystem,
            'Backing up website...'                 => new \Fusion\Jobs\BackupSite,
            'Downloading and extracting release...' => new \Fusion\Jobs\Upgrader\DownloadAndExtractRelease,
            'Copying files over...'                 => new \Fusion\Jobs\Upgrader\CopyFiles,
            'Installing Composer dependencies...'   => new \Fusion\Jobs\Upgrader\InstallComposerDependencies,
            'Optimizing modules...'                 => new \Fusion\Jobs\Upgrader\OptimizeModules,
            'Updating database...'                  => new \Fusion\Jobs\Upgrader\UpdateDatabase,
            'Syncing permissions...'                => new \Fusion\Jobs\Upgrader\SyncPermissions,
            'Syncing system settings...'            => new \Fusion\Jobs\Upgrader\SyncSettings,
            'Syncing system notifications'          => new \Fusion\Jobs\SyncSystemNotifications,
            'Cleaning up files...'                  => new \Fusion\Jobs\Upgrader\CleanUpFiles,
            'Clearing cache...'                     => new \Fusion\Jobs\Upgrader\ClearCache,
