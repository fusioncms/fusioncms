...
class Install extends Command
{
    ...
    protected function install()
    {
        $jobs = [
            ...
            'Creating user permissions...'      => new \Fusion\Jobs\Installer\CreatePermissions,
            'Creating default user roles...'    => new \Fusion\Jobs\Installer\CreateDefaultUserRoles($this->container),
            'Creating default user account...'  => new \Fusion\Jobs\Installer\CreateDefaultUser($this->container),
            'Creating OAuth keys...'            => new \Fusion\Jobs\Installer\CreateOAuthKeys,
            'Creating Passport clients...'      => new \Fusion\Jobs\Installer\CreatePassportClients,
    ...
    {
        $serverPassed = dispatch(new \Fusion\Jobs\Installer\CheckServerRequirements($this->requirements));
